...
## Gallery of Images from this Trimester

<script>
        // Use local images stored under /images/games/ and update descriptions
        var games_http_source = (site_base && site_base !== '')
            ? (site_base.replace(/\/$/, '') + '/images/Achievments/')
            : '{{ site.baseurl }}/images/Achievments/';

        var games = [
            {"img": "mcarchie-(1).png", "title": "Main Character", "desc": "I desgned the sprite and animations for the main character of the class game"},
            {"img": "map-boss.png", "title": "Boss Map", "desc": "One of the maps I designed for the game, meant to be used in the boss fight"},
            {"img": "Background.png", "title": "Prep Map", "desc": "Another map I made for the class game, used in the preparation level my group made"},
            {"img": "pong.jpeg", "title": "Pong Hack", "desc": "A screenshot I took of the pong hack which I edited earlier in the trimester"}
        ];
